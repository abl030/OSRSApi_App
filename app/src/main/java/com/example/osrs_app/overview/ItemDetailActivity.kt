...
class ItemDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel2.timeSeriesData.observe(this) { timeSeriesData ->
            ...
            //some view's need to observse the time series data to update
            viewModel2.timeSeriesData.observe(this) {
                ...
                timeSeriesRatio.text =
                    formatRatio(hightolowratioString(viewModel2.timeSeriesData.value))

                timeSeriesRatioWarning.text =
                    ratioWarnings(hightolowratioString(viewModel2.timeSeriesData.value))

                //fancy let just in case the value is null
